...
static struct gpiomux_setting f3q_wtr_io_pwr = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_16MA,
       .pull = GPIOMUX_PULL_UP,
       .dir = GPIOMUX_OUT_HIGH,
...
static struct msm_gpiomux_config f3q_wtr_io_pwr_configs[] __initdata = {
       {
               .gpio = 51,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &f3q_wtr_io_pwr,
                       [GPIOMUX_ACTIVE] = &f3q_wtr_io_pwr,
               },
       },
};
#endif
...
#ifdef CONFIG_MACH_LGE_FX3_VZW
       msm_gpiomux_install(f3q_wtr_io_pwr_configs,
                       ARRAY_SIZE(f3q_wtr_io_pwr_configs));
#endif
