...
/*                                                                                           */
#if defined(CONFIG_MACH_MSM8930_FX3)
static unsigned int smem_size;
static unsigned int cable_type = 0;
#endif
/*         */
...
/*                                                                                           */
	...
	if(cable_type == 6 || cable_type == 7 || cable_type == 11){
		printk("*** When booting by LT_cable of 56K, 130K or 910K, not turn on/off amp by requesting factory *** cable_type = %d\n", cable_type);
		return 0;
		}	
#endif
/*         */
...
/*                                                                                           */
#if defined(CONFIG_MACH_MSM8930_FX3)
	cable_type = *(unsigned int *) (smem_get_entry(135, &smem_size));
#endif
/*         */
